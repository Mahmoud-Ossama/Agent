...
Examples:
  ...
  python run_enhanced_agent.py --target vulnerable-app.local --mode intelligent
    ...
    parser.add_argument(
        "--mode",
        choices=["intelligent", "dynamic", "mcp_basic", "mcp_human"],
        default="intelligent",
    ...
    try:
        ...
        if args.mode == "intelligent":
            ...
            agent = MCPPenTestAgent(target_url)
        ...
        if hasattr(agent, 'max_iterations_per_stage'):
            agent.max_iterations_per_stage = args.max_iterations
